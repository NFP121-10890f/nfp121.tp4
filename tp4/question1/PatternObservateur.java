...
public class PatternObservateur extends junit.framework.TestCase {
    ...
    public void testNotify() {
        ...
        list = new ConcreteSubject();           // cré?ation d'un "observé?" constitué? d'une liste
        observer = new ConcreteObserver();      // cré?ation d'un observateur
        ...
        assertEquals(list, observer.senders().pop());                       // est-ce le bon é?metteur ?
    ...
    public void test1() {
        ...
        l1.insert("test");
        l1.insert(" 1 ");
        // vé?rifier que les deux observateurs ont bien é?té? notifié?s avec les
        // bons paramètres
    ...
    public void test2() {
        ...
        // à complé?ter à partir de la ligne 56
        // vé?rifier que l'observateur a bien é?té? notifié? par les deux listes
    ...
    public void test3() {
        ...
        // à complé?ter à partir de la ligne 81
        // vé?rifier le bon fonctionnement de countObservers(), de deleteObserver
        // et deleteObservers()
